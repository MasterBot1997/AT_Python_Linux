...
def user_name():
    result = subprocess.run('pwd', shell=True, stdout=subprocess.PIPE, encoding='utf-8').stdout.split('/')[2]
    return result
...
if __name__ == '__main__':
    ...
    # func_del_arh('cd ~/shared/AT_Python_Linux/HW_2/test_step_zip/fold_2; rm ./arch_fold_1.7z')
    print(user_name())